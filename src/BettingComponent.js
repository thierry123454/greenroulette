    ...
    <div className={`${commonStyles.container} ${isLoaded ? commonStyles.loaded : ''}`}>
      ...
      <div className={`${commonStyles.popUpContainer} ${styles.settingsContainer} 
        ...
        <div className={styles.settingsMenuButtons}>
          <div className={`${styles.settingsButton} ${!isDonation ? styles.active : ''}`} onClick={() => setIsDonation(false)}>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <>
              ...
              <div className={styles.inputArea}>
                ...
                <div style={{textAlign: 'center'}}>
                  ...
                  <svg className={`${styles.showMore} ${showDonations ? styles.flip : ''}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z"/>
                  </svg>
                      ...
                      <>
                        <div className={styles.recentDonationsContainer}>
                          ...
                          <div className={styles.donation}>
                            <span className={styles.donationAddress}>0x8AB2...2847</span>
                            <span className={styles.donationAmount}>12$</span>
                          </div>
                          <span className={commonStyles.label}>
                            30th July, 2014
                          </span>
